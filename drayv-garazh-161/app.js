...
(function () {
  ...
  function renderHeader() {
    ...
    var phone = C.contacts.phoneDisplay
      ...
      : '';
    var phone2 = C.contacts.phone2Display
      ? '<a class="header__phone header__phone2" href="tel:+' + esc(C.contacts.phone2) + '">' +
          ic('phone', { size: 15 }) + esc(C.contacts.phone2Display) + '</a>'
      : '';
    ...
    '<header class="header" id="site-header">' +
      ...
      '<div class="mobile-menu" id="mobile-menu">' +
        mobileLinks +
        (phone ? '<a href="tel:+' + esc(C.contacts.phone) + '" data-close-menu>' + esc(C.contacts.phoneDisplay) + '</a>' : '') +
        (phone2 ? '<a href="tel:+' + esc(C.contacts.phone2) + '" data-close-menu>' + esc(C.contacts.phone2Display) + '</a>' : '') +
    ...
    return '<footer class="footer"><div class="wrap">' +
      '<div class="footer__grid">' +
        ...
        '<div class="footer__col">' +
          ...
          (C.contacts.phone2Display ? '<a href="tel:+' + esc(C.contacts.phone2) + '">' + esc(C.contacts.phone2Display) + '</a>' : '') +
